# Summary-level simulations with balanced pleiotropy and InSIDE assumption violated
rm(list = ls())
library(data.table)
library(dplyr)
library(MASS)
...
for (repind in 1:200){
    ...
    if (repind%%5==0){
        ...
        save(est, file = paste0("results/bal_NoIA_", "est_theta",theta,"_thetaU",thetaU,"_N",N,"_prop_invalid",prop_invalid,".rda"))
    }
}
save(est, file = paste0("results/bal_NoIA_", "est_theta",theta,"_thetaU",thetaU,"_N",N,"_prop_invalid",prop_invalid,".rda"))
